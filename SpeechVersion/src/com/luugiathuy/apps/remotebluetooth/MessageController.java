...
public  class MessageController 
{
	...
	public static  MessageController mcontroller = null; 
     ...
     static double _gesture_threshold[] =new double []{8,5,2,1,0.5};
    	...
    	int backflag=NoMovement;
            try
            {
                ...
                else
                {
                    ...
                    System.out.println("Original:"+movementvariable);
                    
                    movementvariable = _l1.filtervalue(movementvariable,mIndex-1);
                    System.out.println("Threshold:"+movementvariable+"\nIndex:"+mIndex);
    ...
    public synchronized void Update(int label)
    {
        mylabel = label-1;
