...
//    private int mConnectionLostCount;
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(GestureSpeaker.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(GestureSpeaker.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(GestureSpeaker.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(GestureSpeaker.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
...
//        } else {
	        ...
	        Message msg = mHandler.obtainMessage(GestureSpeaker.MESSAGE_TOAST);
	        Bundle bundle = new Bundle();
	        bundle.putString(GestureSpeaker.TOAST, "Device connection was lost");
	        msg.setData(bundle);
	        mHandler.sendMessage(msg);
//        }
    }
