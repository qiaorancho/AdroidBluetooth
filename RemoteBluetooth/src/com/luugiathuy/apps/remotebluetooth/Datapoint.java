...
/*
 * 
 * 	Function: Read message and divide it into data points.
 * 
 * */
public class Datapoint
    {
        ...
        public Datapoint(String message)
        {
            ...
            _accx = Double.valueOf(split_message[1]);
            _accy = Double.valueOf(split_message[2]);
            _accz = Double.valueOf(split_message[3]);
            _gyrx = Gyro_Scaled(Double.valueOf(split_message[4]));
            _gyry = Gyro_Scaled(Double.valueOf(split_message[5]));
            _gyrz = Gyro_Scaled(Double.valueOf(split_message[6]));
